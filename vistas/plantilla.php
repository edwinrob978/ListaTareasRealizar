...
<head>
    ...
    <link rel="stylesheet" href="vistas/assets/dist/css/plantilla2.css">
    <link rel="stylesheet" href="vistas/assets/dist/css/plantilaProductos.css">
...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <?php
        include "vistas/modulos/narbar.php";
        include "vistas/modulos/aside.php";
        ?>
        <!-- Content Wrapper. Contains page content -->
        <div class="content-wrapper">
            <?php include "vistas/tareas.php" ?>
        </div>
        <!-- /.content-wrapper -->
        <?php
